...
- **Dedicated Audit Regression Suite**: Added [`test/run-audit-regressions.mjs`](file:///home/pc/mew/eyeprolog.ts/test/run-audit-regressions.mjs) to continuously verify:
